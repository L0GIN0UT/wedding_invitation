...
import { Calendar, Clock, MapPin, Check, X, Heart, Users, Camera, Music, Utensils, Wine, ChevronLeft, ChevronRight } from 'lucide-react';
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 xl:gap-16 items-center">
            ...
            <motion.div
              ...
              className="text-center space-y-6 py-8 px-4 lg:px-6 order-1 lg:order-2"
            >
              <div>
              ...
              {timeline.map((item, index) => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div className="elegant-card p-6 md:inline-block md:block">
